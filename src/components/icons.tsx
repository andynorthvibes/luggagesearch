// Hand-drawn inline icons — stroke-based, 24px grid. No icon package needed.

type IconProps = { className?: string };

// The site's mark: a rounded suitcase with a top handle and a centre strap.
export function LuggageIcon({ className = "h-5 w-5" }: IconProps) {
  return (
...
export function PlaneIcon({ className = "h-3.5 w-3.5" }: IconProps) {
  return (
